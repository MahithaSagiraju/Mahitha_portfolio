    ...
    <section id="projects" className="py-20 scroll-mt-[86px]">
      <div className="container mx-auto px-4" style={{ maxWidth: "var(--container, 1100px)" }}>
        <header className="mb-6">
          <h2 className="font-['Plus_Jakarta_Sans'] text-2xl sm:text-3xl -tracking-wide">Projects</h2>
          <p className="text-white/60">A couple of projects that show my work with APIs and responsive UI.</p>
        </header>
